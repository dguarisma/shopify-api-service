...
func TestAll(t *testing.T) {
	defer utils.DeleteInfo(&model.TypesProduct{})

	first := typesproducts.Adapt{
		Name:   "Example1",
		Status: true,
	}

	manyWithoutUpdate := []typesproducts.Adapt{
		{
			Name:   "Example",
			Status: false,
		},
	...
	manyWithUpdate := []typesproducts.Adapt{}

	newElement := typesproducts.Adapt{
		Name:   "New-Item",
		Status: true,
	}
	...
	t.Run("Delete first Item", func(t *testing.T) {
		...
		responseAdap := typesproducts.Adapt{}
